...
- создание, включение, выключение, удаление и смена интерфейса правил
  DNS-маршрутизации;
- массовая смена интерфейса DNS-правил для выбранных FQDN-списков;
...
**«Массово сменить интерфейс»** в разделе DNS-списков позволяет отметить
несколько списков, выбрать новый интерфейс и обновить все связанные с ними
DNS-правила после подтверждения. Состояние правил и параметр `exclusive` при
этом сохраняются.
